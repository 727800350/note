...
\begin{figure}[h!]
    ...
    \subfigure[中]{
        \label{fig-sub-c}
        \includegraphics[width=.2\textwidth]{nombre_quantique_n_2}
    }
    \hspace{7em} % 水平间隔
    \subfigure[大]{
        \label{fig-sub-r}
        \includegraphics[width=.2\textwidth]{nombre_quantique_n_3}
    }
...
\begin{figure}[h!]
    ...
    \subfigure[小]{
        \label{fig-sub-l}
		\includegraphics[width=.2\textwidth]{nombre_quantique_effet-zeeman_1}
    }
    \hspace{7em} % 水平间隔
    \subfigure[中]{
        \label{fig-sub-c}
		\includegraphics[width=.2\textwidth]{nombre_quantique_effet-zeeman_2}
    }
    \caption{n的不同对应于半径大小的不同}
    \label{fig-sub}
\end{figure}
...
\begin{figure}[h!]
    ...
    \subfigure[小]{
        \label{fig-sub-l}
		\includegraphics[width=.2\textwidth]{resistance_forte}
    }
    \hspace{7em} % 水平间隔
    \subfigure[中]{
        \label{fig-sub-c}
		\includegraphics[width=.2\textwidth]{resistance_faible}
    }
    \caption{n的不同对应于半径大小的不同}
    \label{fig-sub}
\end{figure}
