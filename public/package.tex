...
% Geometry
\usepackage[paper=a4paper, top=.5cm, bottom=1.5cm, left=2cm, right=1cm]{geometry} % ms word
%% \usepackage[paper=a4paper, top=2.54cm, bottom=2.54cm, left=3.18cm, right=3.18cm]{geometry} % ms word
%% \usepackage[top=0.1cm, bottom=0.1cm, left=0.1cm, right=0.1cm, paperwidth=9cm, paperheight=11.7cm]{geometry} % kindle

% Code
%% \textbf can be used in alltt, but not in verbatim
%% \usepackage{alltt}
...
%% \usepackage{fixltx2e} %% 默认情况下只能使用\textsuperscript,加了这个package之后可以使用\textsubscript
