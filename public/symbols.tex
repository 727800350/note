...
\section{Binary Operation Symbols}
\begin{table}
\begin{tabular}{*8l}
...
\section{Large Delimiters\label{ldels}}
\begin{table}
\begin{tabular}{*8l}
...
\section{Math mode accents\label{accent}}
\begin{table}
\begin{tabular}{*{10}l}
...
\section{Some other constructions}
\begin{table}
\begin{tabular}{*4l}
...
\section{AMS Delimiters\label{ams-del}}
\begin{table}
\begin{tabular}{*8l}
...
\section{AMS Arrows\label{ams-arrows}}
\begin{table}
\begin{tabular}{*8l}
...
\section{AMS Negated Arrows\label{ams-narrows}}
\begin{table}
\begin{tabular}{*8l}
\X\nleftarrow   &\X\nrightarrow &\X\nLeftarrow  &\X\nRightarrow \\
\X\nleftrightarrow&\X\nLeftrightarrow
...
\section{AMS Greek\label{ams-greek}}
\begin{table}
\begin{tabular}{*4l}
...
\section{AMS Hebrew\label{ams-hebrew}}
\begin{table}
\begin{tabular}{*6l}
...
\section{AMS Miscellaneous\label{ams-misc}}
\begin{table}
\begin{tabular}{*8l}
...
\section{AMS Binary Operators\label{ams-bin}}
\begin{table}
\begin{tabular}{*8l}
...
\section{AMS Binary Relations\label{ams-rel}}
\begin{table}
\begin{tabular}{*8l}
...
\end{table}
%
\section{AMS Negated Binary Relations\label{ams-nrel}}
\begin{table}
\begin{tabular}{*8l}
\X\nless        &\X\nleq        &\X\nleqslant   &\X\nleqq       \\
...
\section{\ST\ Delimiters\label{st-del}}
\begin{table}
\begin{tabular}{*8l}
...
\section{\ST\ Extension Characters\label{st-ext}}
\begin{table}
\begin{tabular}{*8l}
...
\section{\ST\ Binary Operators\label{st-bin}}
\begin{table}
\begin{tabular}{*8l}
...
\section{\ST\ Large Binary Operators\label{st-lbin}}
\begin{table}
\begin{tabular}{*8l}
...
\section{\ST\ Binary Relations\label{st-rel}}
\begin{table}
\begin{tabular}{*8l}
\X\inplus     &\X\niplus       &\X\subsetplus
                                             &\X\subsetpluseq        \\
...
\section{\ST\ Negated Binary Relations\label{st-nrel}}
\begin{table}
\begin{tabular}{*8l}
...
\section{Math Alphabets\label{alphabets}}
\begin{table}
\begin{tabular}{*3l}
                     &&Required package                     \\
\hline
