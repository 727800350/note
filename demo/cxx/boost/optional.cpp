...
int main()
{
	// Boost has a library called Random. If you wonder why it was written when stdlib.h has rand() function, see the recipe
	// "Using a true random number generator in Chapter 12, Scratching the Tip of the Iceberg
	srandom(5);
