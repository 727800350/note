...
#
## any platform
## 其中的_tester可作为使用样例，也可稍作改动进行发送测试
## update 2014-01-01: 
##     修改Email类，可添加Pwd初始化参数以实现认证服务器的连接;
##     修改attach的方法,使之能够更准确地附加图像,音频,文本等不同类型的文件
## update 2013-12-31: 修改writemail方法，支持在命名参数中设attach,指定一个或一组文件名作为附件
