- [Accustoming yourself to C++](#accustoming-yourself-to-c)
  - [prefer const, enum, and inlines to `#define`s](#prefer-const-enum-and-inlines-to-defines)
  - [use const whenever possible](#use-const-whenever-possible)
  - [Minimize casting](#minimize-casting)
...
- [Constructors, Destructors and Assignment Operators](#constructors-destructors-and-assignment-operators)
  - [Nevel call virtual functions during construction or destruction](#nevel-call-virtual-functions-during-construction-or-destruction)
  - [Have assignment operators return a reference to `\*this`](#have-assignment-operators-return-a-reference-to-this)
  - [Hanle assignment to self in operator=](#hanle-assignment-to-self-in-operator)
- [Resouce Management](#resouce-management)
  - [use the same form in corresponding uses of new and delete](#use-the-same-form-in-corresponding-uses-of-new-and-delete)
- [Designs and Declarations](#designs-and-declarations)
  - [Declare non-member functions when type conversions should apply to all parameters](#declare-non-member-functions-when-type-conversions-should-apply-to-all-parameters)
  - [consider support for a non-throwing swap](#consider-support-for-a-non-throwing-swap)
- [Inheritance and Object-Oriented Design](#inheritance-and-object-oriented-design)
  - [make sure public inheritance model "is-a"](#make-sure-public-inheritance-model-is-a)
  - [Avoid hiding inherited names](#avoid-hiding-inherited-names)
  - [differentiate between inheritance of interface and inheritance of implementation](#differentiate-between-inheritance-of-interface-and-inheritance-of-implementation)
  - [never redefine an inherited non-virtual function](#never-redefine-an-inherited-non-virtual-function)
  - [never redefine a function's inherited default parameter value](#never-redefine-a-functions-inherited-default-parameter-value)
  - [Use private inheritance judiciously](#use-private-inheritance-judiciously)
  - [use multiple inheritance judiciously](#use-multiple-inheritance-judiciously)
- [Templates and Generic Programming](#templates-and-generic-programming)
  - [understand the two meanings of typename](#understand-the-two-meanings-of-typename)
  - [know how to access names in templateized base classes](#know-how-to-access-names-in-templateized-base-classes)
  - [use member function templates to accept all compatible types](#use-member-function-templates-to-accept-all-compatible-types)
