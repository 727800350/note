...
- [geom_bar](http://docs.ggplot2.org/current/geom_bar.html)
	...
	- ex:
		1. `ggplot(mpg, aes(manufacturer, fill=class)) + geom_bar()`: [彩色图](http://docs.ggplot2.org/current/geom_bar-44.png)
		1. `ggplot(mpg, aes(manufacturer, fill=class)) + geom_bar() + scale_fill_grey()`: [灰度图](http://docs.ggplot2.org/current/geom_bar-48.png)
- geom_smooth
